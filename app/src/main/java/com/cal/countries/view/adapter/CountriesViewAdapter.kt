package com.cal.countries.view.adapter
...
import com.cal.countries.databinding.CountryListItemBinding
import com.cal.countries.model.domain.DomainModels.*

class
CountriesViewAdapter:ListAdapter<CountryItem,CountriesViewAdapter.ItemViewHolder>(DiffUtilCallBack()){
